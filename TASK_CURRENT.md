...
> 只修改用户明确要求的、或直接相关的最小范围代码；不改动已经完好的功能。
>
> 每次修改前：
> 1. 确认要改的文件和函数是当前任务直接相关的。
> 2. 不要顺手“优化”或“重构”未出问题的代码。
> 3. 修改后只验证当前任务，不扩大测试范围。
> 4. 不确定是否相关的代码，先询问用户再动。
...
3. 修改前后端标识格式必须一致
4. 不确定的地方先验证，不要顺手改
5. **只修改用户明确要求的、或直接相关的最小范围代码；不改动已经完好的功能**
